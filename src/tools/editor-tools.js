...
export const editorTools = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        includeInstanceId: { type: "boolean", description: "Include instanceId for each node (default: true). Set to false to save ~2 tokens/node." },
      },
    },
  ...
  },
  {
    ...
    handler: async (params) => JSON.stringify(await bridge.setComponentReference(params)),
  },
  {
    ...
    handler: async (params) => JSON.stringify(await bridge.batchWireReferences(params)),
  },
  {
  ...
  },
  {
    ...
    handler: async ({ code }) => JSON.stringify(await bridge.executeCode(code)),
  },
  ...
  },
  {
    ...
    inputSchema: { type: "object", properties: {} },
    handler: async () => JSON.stringify(await bridge.sendCommand("scenario/start", {})),
  },
  {
    name: "unity_mppm_stop",
    description: "Stop the running scenario.",
    inputSchema: { type: "object", properties: {} },
    handler: async () => JSON.stringify(await bridge.sendCommand("scenario/stop", {})),
  },
  {
